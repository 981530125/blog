  ...
  <table class="table">
   <tr>
    ...
    <?php if(is_array($useritem)): foreach($useritem as $key=>$v): ?><tr>
        ...
        <td><?php if($v[Status]): ?>激活&nbsp;&nbsp;&nbsp;[<a href="<?php echo U('admin/articlefr/usernostatus',array('id'=>$v['Uid']));?>">不激活</a>]<?php else: ?>未激活&nbsp;&nbsp;&nbsp;[<a href="<?php echo U('admin/articlefr/userstatus',array('id'=>$v['Uid']));?>">激活</a>]<?php endif; ?></td>
        <td>
           <a class="ml" href="">[修改]</a>
           <a class="ml" href="">[删除]</a>
        </td>
